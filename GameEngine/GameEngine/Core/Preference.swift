...
public class ClearColors {
    ...
    static let SpaceGrey = MTLClearColor(red: 0.002, green: 0.002, blue: 0.002, alpha: 1.0)
    ...
    static let SkyBlue = MTLClearColor(red: 0.3, green: 0.4, blue: 0.7, alpha: 1)
    
}

class Preference {
    public static var ClearColor: MTLClearColor = ClearColors.SpaceGrey
    ...
    public static var StartingSceneType: SceneTypes = SceneTypes.UnRealScene
}
